<?PHP // $Id$
      // qtype_phmultichoice.php - created with Moodle 1.7 beta + (2006101003)
...
$string['addingphmultichoice'] = 'Adding a Physics Multichoice question';
$string['choiceno'] = 'Choice $a';
$string['choices'] = 'Available choices';
$string['clozeaid'] = 'Enter missing word';
$string['correctfeedback'] = 'For any correct answer';
$string['editingphmultichoice'] = 'Editing a Physics Multiple Choice question';
