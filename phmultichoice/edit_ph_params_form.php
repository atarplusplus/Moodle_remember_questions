...
class question_ph_params_form extends moodleform {
    ...
    */
    ...
    function question_ph_params_form($submiturl, $question) {
      ...
      //function question_ph_params_form($submiturl, $question, $category, $contexts, $formeditable = false){
       //function question_ph_params_form($submiturl, $question, $formeditable=true){
        global $QTYPES, $CFG;
     ...
     * this form is the second page in the wizard in qtypes- phnumerical, ph_numerical
    */
    function definition() {
        $mform =& $this->_form;

		//javascript to check a radio button
