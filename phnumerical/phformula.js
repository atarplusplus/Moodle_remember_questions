...
function insertMathExpression(htmleditor,tbmathexp) {//alert(htmleditor);
    HTMLArea._object=htmleditor;
	var editor=HTMLArea._object;
	editor.focusEditor();
    //var spanopen='<span class="mathExpression" dir="ltr">';
